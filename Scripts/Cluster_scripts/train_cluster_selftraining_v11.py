...
def plot_probability_distribution(probabilities, gmm, epoch, log_dir):
    ...
    try:
        ...
        plot_dir = os.path.join(log_dir, 'probability_distributions_15_07_v2')
        ...
        if hasattr(self.wrapper_instance, '_self_training_estimator'):
            ...
            if hasattr(estimator, 'transduction_'):
                ...
                if self.previous_labels is not None and iteration > 0:
                    ...
                    prev_unlabeled = (self.previous_labels == -1)
                    now_pos = (self.previous_labels == -1) & (current_labels == 1)
                    now_neg = (self.previous_labels == -1) & (current_labels == 0)
                    still_unlabeled = (self.previous_labels == -1) & (current_labels == -1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_name", type=str, default="self_training_16_07_v2", help="Name of the run")
