...
def main(args):
    csv_logger = CSVLogger(args.log_dir, name="spectra_transformer_best_model_29_06")
    ...
    train_indices, val_indices = train_test_split(
        np.arange(len(combined_dataset)), test_size=args.val_split, random_state=args.seed, stratify=labels
    )
