...
def select_low_prob_samples(args):
    ...
    output_file = "low_probability_indices.txt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="predict_all", choices=["predict_all", "select_low_prob"], help="Operation mode")
    ...
    parser.add_argument("--num_samples", type=int, default=107360, help="Number of samples to select")
